...
namespace RenderJoy
{
    ...
    {
        return AZ::Vector2(aznumeric_caster(m_settingsConfig.m_renderTargetWith), aznumeric_caster(m_settingsConfig.m_renderTargetHeight));
    }
    //////////////////////////////////////////////////////////////////////////
    ...
    void RenderJoySettingsEditorComponent::OnConfigChanged()
    {
        ...
        RenderJoySettingsNotificationBus::Broadcast(
            ...
            AZ::Vector2(aznumeric_caster(m_settingsConfig.m_renderTargetWith), aznumeric_caster(m_settingsConfig.m_renderTargetHeight)));
    }
